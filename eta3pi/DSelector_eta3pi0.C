...
//		areaRatio = 0.067; //double checked these values;
		...
		double scaleUp = 3;
		ellipseXBS1 = 0.135881; ellipseYBS1 = 0.548625; ellipseXrBS1 = 0.026; ellipseYrBS1 = 0.026*ellipseXYratio;	
	...
	for (int i =0; i<3; ++i){
		if (is_pi0eta){
			...
			dHist_checkEllipseBS[i] = new TH2F(("checkEllipseBS"+std::to_string(i)+"noCutOnlyRegionSelected").c_str(), ";#pi_{0} Mass (GeV) with Events / 0.001 GeV;#pi_{0} Mass (GeV) with Events / 0.001 GeV", atof(pi0BinRange[0].c_str()), atof(pi0BinRange[1].c_str()), atof(pi0BinRange[2].c_str()), atof(pi0BinRange[0].c_str()), atof(pi0BinRange[1].c_str()), atof(pi0BinRange[2].c_str()));
		}
	}
...
// **************************************** START INITIALZING VARIABLES TO USE WITH HISTO BUILDING ********************************************//
	...
	// *************************** PHOTON VECTOR QUANTITIES ****************************
        ...
        histdef.values.push_back( &(photonXs_Kin[4]) );
        histdef.values.push_back( &(photonXs_Kin[5]) );
        histdef.values.push_back( &(photonXs_Kin[6]) );
        histdef.values.push_back( &(photonXs_Kin[7]) );
        ...
        histdef.values.push_back( &(photonYs_Kin[4]) );
        histdef.values.push_back( &(photonYs_Kin[5]) );
        histdef.values.push_back( &(photonYs_Kin[6]) );
        histdef.values.push_back( &(photonYs_Kin[7]) );
        group_PhNB.insert(histdef);
        ...
        histdef.values.push_back( &(photonZs_Kin[4]) );
        histdef.values.push_back( &(photonZs_Kin[5]) );
        histdef.values.push_back( &(photonZs_Kin[6]) );
        histdef.values.push_back( &(photonZs_Kin[7]) );
        group_PhNB.insert(histdef);
        ...
        histdef.values.push_back( &(photonTs_Kin[4]) );
        histdef.values.push_back( &(photonTs_Kin[5]) );
        histdef.values.push_back( &(photonTs_Kin[6]) );
        histdef.values.push_back( &(photonTs_Kin[7]) );
        group_PhNB.insert(histdef);
        ...
        histdef.values.push_back( &(photonXs_Shower[4]) );
        histdef.values.push_back( &(photonXs_Shower[5]) );
        histdef.values.push_back( &(photonXs_Shower[6]) );
        histdef.values.push_back( &(photonXs_Shower[7]) );
        group_PhNB.insert(histdef);
        ...
        histdef.values.push_back( &(photonYs_Shower[4]) );
        histdef.values.push_back( &(photonYs_Shower[5]) );
        histdef.values.push_back( &(photonYs_Shower[6]) );
        histdef.values.push_back( &(photonYs_Shower[7]) );
        group_PhNB.insert(histdef);
        ...
        histdef.values.push_back( &(photonZs_Shower[4]) );
        histdef.values.push_back( &(photonZs_Shower[5]) );
        histdef.values.push_back( &(photonZs_Shower[6]) );
        histdef.values.push_back( &(photonZs_Shower[7]) );
        group_PhNB.insert(histdef);
        ...
        histdef.values.push_back( &(photonTs_Shower[4]) );
        histdef.values.push_back( &(photonTs_Shower[5]) );
        histdef.values.push_back( &(photonTs_Shower[6]) );
        histdef.values.push_back( &(photonTs_Shower[7]) );
        group_PhNB.insert(histdef);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=GeneralCuts;cos(#theta) of #pi_{0};Events / 0.02", 100,-1,1);
        histdef.name = name; histdef.cut=&allGeneralCutsPassed; histdef.weights = &weightAS;
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=GeneralCuts;cos(#theta) of #pi_{0}+#eta;Events / 0.02",100,-1,1);
        histdef.name = name; histdef.cut=&allGeneralCutsPassed; histdef.weights = &weightAS;
        ...
        histdef2d.hist = new TH2F(name.c_str(), "Cut=mMandelstamT_mdelta;M(#pi_{0} p)Events / 0.01 GeV;Cos(#theta) of #eta Events / 0.2",350,0,3.5,100,-1,1);
        ...
        histdef2d.hist = new TH2F(name.c_str(), "Cut=mMandelstamT AS;M(#pi_{0}#eta)Events / 0.01 GeV;#phi of #eta Events / 4 degrees",350,0,3.5,100,-180,180);
        histdef2d.name = name; histdef2d.cut=&mMandelstamT; histdef2d.weights = &weightAS;
        histdef2d.valuesX.push_back( &locPi0Eta_Kin );
        ...
        histdef2d.hist = new TH2F(name.c_str(), "Cut=GeneralCuts;M(#pi_{0}#eta)Events / 0.01 GeV;#phi of #eta Events / 4 degrees",350,0,3.5,90,-180,180);
        histdef2d.name = name; histdef2d.cut=&allGeneralCutsPassed; histdef2d.weights = &weightAS;
        histdef2d.valuesX.push_back( &locPi0Eta_Kin );
        histdef2d.valuesY.push_back( &phi_eta_GJ );
        group_34B_1234B.insert_2D(histdef2d); 
        ...
        histdef.hist = new TH1F(name.c_str(),"Cut=GeneralCuts;cos(#theta) of #pi_{0}+#eta;Events / 0.02", 100,-1,1 );
        histdef.name = name; histdef.cut=&allGeneralCutsPassed; histdef.weights = &weightAS;
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=GeneralCuts;M(#pi_{0}) GeV; Events / 0.001 GeV", 200, 0.05,0.25);
        histdef.name = name; histdef.cut=&allGeneralCutsPassed; histdef.weights = &weightAS;
        ...
        histdef2d.hist = new TH2F(name.c_str(), "Cuts=GeneralCuts;M(#pi_{0}) GeV Events / 0.001 GeV;#eta Mass (GeV) with Events / 0.002 GeV", 200,0.05,0.25,300,0.25,0.85 );
        histdef2d.name = name; histdef2d.cut=&allGeneralCutsPassed; histdef2d.weights = &weightAS;
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mEllipse_pre;M(#pi_{0}) (GeV);Events / 0.001 GeV",200,0.05,0.25);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mEllipse_pre*InFCAL;M(#pi_{0}) (GeV);Events / 0.001 GeV",200,0.05,0.25);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mEllipse_pre*InBCAL;M(#pi_{0}) (GeV);Events / 0.001 GeV",200,0.05,0.25);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mEllipse_pre*SPLIT;M(#pi_{0}) (GeV);Events / 0.001 GeV",200,0.05,0.25);
	...
	for (int iTBin=0; iTBin<10; ++iTBin){
        	...
        	histdef.hist = new TH1F(name.c_str(), ("Cuts=mMandelstamT*p_massTBinned["+to_string(iTBin)+"];M(#pi_{0}#eta) (GeV);Events / 0.02 GeV").c_str(), 125, 0, 3.5);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mEllipse_pre_tAll;M(#pi_{0}#eta) (GeV);Events / 0.01 GeV", 350, 0, 3.5);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=GeneralCuts*BaryBkg;M(#pi_{0}#eta) (GeV);Events / 0.01 GeV", 350, 0, 3.5);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=GeneralCuts*vanHove;M(#pi_{0}#eta) (GeV);Events / 0.01 GeV", 350, 0, 3.5);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mMPi0P14_ellipse;M(#pi_{0}proton) (GeV);Events / 0.01 GeV", 400,0,4);
	...
	// -------------------- SHOW THESE FIRST BEFORE ANY CUTTING ------------------------------
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mMandelstamT_mdelta;-t' momentum transfer of #pi_{0}+#eta;Events / 0.06 GeV", 100, 0, 6);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mMandelstamT_mdelta;M(#pi_{0}proton) (GeV);Events / 0.01 GeV", 400,0,4);
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mMandelstamT_mdelta;M(#pi_{0}#eta) (GeV);Events / 0.01 GeV", 350, 0, 3.5);
        histdef.name = name; histdef.cut=&mMandelstamT_mdelta; histdef.weights = &weightAS;
        histdef.values.push_back( &locPi0Eta_Kin );
        group_1234B.insert(histdef); 
	...
	// -------------------- NOW WE USE M(ETAPROTON) AS THE PRIMARY ---------------------
        ...
        histdef.hist = new TH1F(name.c_str(), "Cuts=mMandelstamT_mdelta_petaProton;-t' momentum transfer of #pi_{0}+#eta;Events / 0.06 GeV", 100, 0, 6);
...
Bool_t DSelector_ver20::Process(Long64_t locEntry)
{
	...
	if (Get_NumThrown() != 0 ) {
		...
		for (auto parent : parents){
			...
			for ( auto daughter=0; daughter < (int)daughters.size(); ++daughter) {
				...
				if ( pids[parent]==17 && pids[daughters[daughter]] == 7 && daughters.size()==3){ ++etaToNPi0; }
			}
		}
    ...
    for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
    {
        ...
        Int_t locPhoton5NeutralID = dPhoton5Wrapper->Get_NeutralID();
        Int_t locPhoton6NeutralID = dPhoton6Wrapper->Get_NeutralID();
        Int_t locPhoton7NeutralID = dPhoton7Wrapper->Get_NeutralID();
        Int_t locPhoton8NeutralID = dPhoton8Wrapper->Get_NeutralID();
        ...
        TLorentzVector locPhoton5X4_Kin = dPhoton5Wrapper->Get_X4();
        TLorentzVector locPhoton6X4_Kin = dPhoton6Wrapper->Get_X4();
        TLorentzVector locPhoton7X4_Kin = dPhoton7Wrapper->Get_X4();
        TLorentzVector locPhoton8X4_Kin = dPhoton8Wrapper->Get_X4();
        ...
        TLorentzVector locPhoton5P4_Kin = dPhoton5Wrapper->Get_P4();
        TLorentzVector locPhoton6P4_Kin = dPhoton6Wrapper->Get_P4();
        TLorentzVector locPhoton5P4 = dPhoton5Wrapper->Get_P4_Measured();
        TLorentzVector locPhoton6P4 = dPhoton6Wrapper->Get_P4_Measured();
        TLorentzVector locPhoton7P4_Kin = dPhoton7Wrapper->Get_P4();
        TLorentzVector locPhoton8P4_Kin = dPhoton8Wrapper->Get_P4();
        TLorentzVector locPhoton7P4 = dPhoton7Wrapper->Get_P4_Measured();
        TLorentzVector locPhoton8P4 = dPhoton8Wrapper->Get_P4_Measured();
        ...
        TLorentzVector locPhoton5X4_Shower = dPhoton5Wrapper->Get_X4_Shower();
        TLorentzVector locPhoton6X4_Shower = dPhoton6Wrapper->Get_X4_Shower();
        TLorentzVector locPhoton7X4_Shower = dPhoton7Wrapper->Get_X4_Shower();
        TLorentzVector locPhoton8X4_Shower = dPhoton8Wrapper->Get_X4_Shower();
        ...
        allPhotonP4Vectors_Kin.push_back(locPhoton5P4_Kin);
        allPhotonP4Vectors_Kin.push_back(locPhoton6P4_Kin);
        allPhotonP4Vectors_Kin.push_back(locPhoton7P4_Kin);
        allPhotonP4Vectors_Kin.push_back(locPhoton8P4_Kin);
        ...
        allPhotonX4Vectors_Kin.push_back(locPhoton5X4_Kin);
        allPhotonX4Vectors_Kin.push_back(locPhoton6X4_Kin);
        allPhotonX4Vectors_Kin.push_back(locPhoton7X4_Kin);
        allPhotonX4Vectors_Kin.push_back(locPhoton8X4_Kin);
        ...
        allPhoton4Vectors_Shower.push_back(locPhoton5X4_Shower);
        allPhoton4Vectors_Shower.push_back(locPhoton6X4_Shower);
        allPhoton4Vectors_Shower.push_back(locPhoton7X4_Shower);
        allPhoton4Vectors_Shower.push_back(locPhoton8X4_Shower);
        ...
        allPhotonWrappers.push_back(dPhoton5Wrapper);
        allPhotonWrappers.push_back(dPhoton6Wrapper);
        allPhotonWrappers.push_back(dPhoton7Wrapper);
        allPhotonWrappers.push_back(dPhoton8Wrapper);
        ...
        photonIds.push_back(locPhoton5NeutralID);
        photonIds.push_back(locPhoton6NeutralID);
        photonIds.push_back(locPhoton7NeutralID);
        photonIds.push_back(locPhoton8NeutralID);
	...
	if(showOutput){cout << "There are " << nPhotons << " photons" << endl;  }
        ...
        locMissingP4 -= locProtonP4 + locPhoton1P4 + locPhoton2P4 + locPhoton3P4 + locPhoton4P4 + locPhoton5P4 + locPhoton6P4 + locPhoton7P4 + locPhoton8P4;
        ...
        TLorentzVector locEtaP4_Kin = locPhoton3P4_Kin + locPhoton4P4_Kin + locPhoton5P4_Kin + locPhoton6P4_Kin + locPhoton7P4_Kin + locPhoton8P4_Kin;
        TLorentzVector locPi0P4 = locPhoton1P4 + locPhoton2P4;
        TLorentzVector locEtaP4 = locPhoton3P4 + locPhoton4P4 + locPhoton5P4 + locPhoton6P4 + locPhoton7P4 + locPhoton8P4;
        ...
        */
        ...
        TLorentzVector anyVertexMomentum3;
        TLorentzVector anyVertexMomentum4;
        TLorentzVector anyVertexMomentum5;
        TLorentzVector anyVertexMomentum6;
        ...
        vecFromVertexToShower = locPhoton5X4_Shower.Vect()-locProtonX4_Kin.Vect();
        vecFromVertexToShower *= locPhoton5P4.E()/vecFromVertexToShower.Mag();
        anyVertexMomentum3.SetVect(vecFromVertexToShower);
        anyVertexMomentum3.SetE(locPhoton5P4.E());
        vecFromVertexToShower = locPhoton6X4_Shower.Vect()-locProtonX4_Kin.Vect();
        vecFromVertexToShower *= locPhoton6P4.E()/vecFromVertexToShower.Mag();
        anyVertexMomentum4.SetVect(vecFromVertexToShower);
        anyVertexMomentum4.SetE(locPhoton6P4.E());
        vecFromVertexToShower = locPhoton7X4_Shower.Vect()-locProtonX4_Kin.Vect();
        vecFromVertexToShower *= locPhoton7P4.E()/vecFromVertexToShower.Mag();
        anyVertexMomentum5.SetVect(vecFromVertexToShower);
        anyVertexMomentum5.SetE(locPhoton7P4.E());
        vecFromVertexToShower = locPhoton8X4_Shower.Vect()-locProtonX4_Kin.Vect();
        vecFromVertexToShower *= locPhoton8P4.E()/vecFromVertexToShower.Mag();
        anyVertexMomentum6.SetVect(vecFromVertexToShower);
        anyVertexMomentum6.SetE(locPhoton8P4.E());
        locEtaMass_charged = (anyVertexMomentum1+anyVertexMomentum2+anyVertexMomentum3+anyVertexMomentum4+anyVertexMomentum5+anyVertexMomentum6).M();
        ...
        anyVertexMomentum2.SetVect(vecFromVertexToShower);
        anyVertexMomentum2.SetE(locPhoton4P4.E());
        vecFromVertexToShower = locPhoton5X4_Shower.Vect()-targetCenter;
        vecFromVertexToShower *= locPhoton5P4.E()/vecFromVertexToShower.Mag();
        anyVertexMomentum3.SetVect(vecFromVertexToShower);
        anyVertexMomentum3.SetE(locPhoton5P4.E());
        vecFromVertexToShower = locPhoton6X4_Shower.Vect()-targetCenter;
        vecFromVertexToShower *= locPhoton6P4.E()/vecFromVertexToShower.Mag();
        anyVertexMomentum4.SetVect(vecFromVertexToShower);
        anyVertexMomentum4.SetE(locPhoton6P4.E());
        vecFromVertexToShower = locPhoton7X4_Shower.Vect()-targetCenter;
        vecFromVertexToShower *= locPhoton7P4.E()/vecFromVertexToShower.Mag();
        anyVertexMomentum5.SetVect(vecFromVertexToShower);
        anyVertexMomentum5.SetE(locPhoton7P4.E());
        vecFromVertexToShower = locPhoton8X4_Shower.Vect()-targetCenter;
        vecFromVertexToShower *= locPhoton8P4.E()/vecFromVertexToShower.Mag();
        anyVertexMomentum6.SetVect(vecFromVertexToShower);
        anyVertexMomentum6.SetE(locPhoton8P4.E());
        locEtaMass_target = (anyVertexMomentum1+anyVertexMomentum2+anyVertexMomentum3+anyVertexMomentum4+anyVertexMomentum5+anyVertexMomentum6).M();
	...
	if (showOutput){ cout << "Filling photon variables" << endl; } 
        ...
        if(showOutput){ cout << "Set up allPhoton4Vectors_Shower and photonIds to use for pairwise quantity calculating!" << endl;}
        	...
        	for(int j=i+1; j<nPhotons;j++){
        		...
        		if(photonDetectedSyss[i]==SYS_FCAL && photonDetectedSyss[j]==SYS_FCAL){
        			...
        			usingPairIdsFCAL[Gamma].insert(photonIds[j]);
                        	dij3 = (allPhoton4Vectors_Shower[i]-allPhoton4Vectors_Shower[j]).Vect().Mag();
        			...
        			usingPairIdsBCAL[Gamma].insert(photonIds[j]);
                        	...
                        	angle_ij = (allPhoton4Vectors_Shower[i].Vect().Angle(allPhoton4Vectors_Shower[j].Vect()))*radToDeg;
                        	if (angle_ij > 180) { angle_ij = 360-angle_ij; }
                        	deltaZ_ij = abs(allPhoton4Vectors_Shower[i].Z()-allPhoton4Vectors_Shower[j].Z());
                        	deltaPhi_ij = abs(allPhoton4Vectors_Shower[i].Phi()-allPhoton4Vectors_Shower[j].Phi())*radToDeg;
        			...
        			R_BCALi = TMath::Sqrt(TMath::Sq(allPhoton4Vectors_Shower[i].X())+TMath::Sq(allPhoton4Vectors_Shower[i].Y()));
        			z_BCALi = allPhoton4Vectors_Shower[i].Z();
        			theta_BCALi = TMath::ATan(allPhoton4Vectors_Shower[i].Y()/allPhoton4Vectors_Shower[i].X());
        			R_BCALj = TMath::Sqrt(TMath::Sq(allPhoton4Vectors_Shower[j].X())+TMath::Sq(allPhoton4Vectors_Shower[j].Y()));
        			z_BCALj = allPhoton4Vectors_Shower[j].Z();
        			theta_BCALj = TMath::ATan(allPhoton4Vectors_Shower[j].Y()/allPhoton4Vectors_Shower[j].X());
	...
	// some extra variables from the measured 4 vectors
        ...
        usingCombo[Gamma].insert(locPhoton5NeutralID);
        usingCombo[Gamma].insert(locPhoton6NeutralID);
        usingCombo[Gamma].insert(locPhoton7NeutralID);
        usingCombo[Gamma].insert(locPhoton8NeutralID);
        ...
        using34B[Gamma].insert(locPhoton5NeutralID);
        using34B[Gamma].insert(locPhoton6NeutralID);
        using34B[Gamma].insert(locPhoton7NeutralID);
        using34B[Gamma].insert(locPhoton8NeutralID);

        map<Particle_t, set<Int_t> > using34;
        using34[Gamma].insert(locPhoton3NeutralID);
        using34[Gamma].insert(locPhoton4NeutralID);
        using34[Gamma].insert(locPhoton5NeutralID);
        using34[Gamma].insert(locPhoton6NeutralID);
        using34[Gamma].insert(locPhoton7NeutralID);
        using34[Gamma].insert(locPhoton8NeutralID);
        ...
        using1234B[Gamma].insert(locPhoton5NeutralID);
        using1234B[Gamma].insert(locPhoton6NeutralID);
        using1234B[Gamma].insert(locPhoton7NeutralID);
        using1234B[Gamma].insert(locPhoton8NeutralID);
        ...
        using1234[Gamma].insert(locPhoton5NeutralID);
        using1234[Gamma].insert(locPhoton6NeutralID);
        using1234[Gamma].insert(locPhoton7NeutralID);
        using1234[Gamma].insert(locPhoton8NeutralID);
        ...
        using34PB[Gamma].insert(locPhoton5NeutralID);
        using34PB[Gamma].insert(locPhoton6NeutralID);
        using34PB[Gamma].insert(locPhoton7NeutralID);
        using34PB[Gamma].insert(locPhoton8NeutralID);
        ...
        using1234PB[Gamma].insert(locPhoton5NeutralID);
        using1234PB[Gamma].insert(locPhoton6NeutralID);
        using1234PB[Gamma].insert(locPhoton7NeutralID);
        using1234PB[Gamma].insert(locPhoton8NeutralID);
        ...
        usingPhB.clear();
        usingPhB[Unknown].insert(locBeamID);
        usingPhB[Gamma].insert(locPhoton5NeutralID);
        beingUsedNeutralIds.push_back( usingPhB );
        usingPhB.clear();
        usingPhB[Unknown].insert(locBeamID);
        usingPhB[Gamma].insert(locPhoton6NeutralID);
        beingUsedNeutralIds.push_back( usingPhB );
        usingPhB.clear();
        usingPhB[Unknown].insert(locBeamID);
        usingPhB[Gamma].insert(locPhoton7NeutralID);
        beingUsedNeutralIds.push_back( usingPhB );
        usingPhB.clear();
        usingPhB[Unknown].insert(locBeamID);
        usingPhB[Gamma].insert(locPhoton8NeutralID);
        beingUsedNeutralIds.push_back( usingPhB );
	...
	// weightB would be the conjugate of the weight such that weightB+weightBS=(1,1,1,1)
        ...
        pPhoton5E = photonEnergies[4] >= ECut;
        pPhoton6E = photonEnergies[5] >= ECut;
        pPhoton7E = photonEnergies[6] >= ECut;
        pPhoton8E = photonEnergies[7] >= ECut;
        pPhotonE = pPhoton1E*pPhoton2E*pPhoton3E*pPhoton4E*pPhoton5E*pPhoton6E*pPhoton7E*pPhoton8E;
        ...
        pPhoton5Theta = (photonThetas[4]*radToDeg>=thetaCutMin && photonThetas[4]*radToDeg<=thetaCutMax1) || photonThetas[4]*radToDeg>=thetaCutMax2;
        pPhoton6Theta = (photonThetas[5]*radToDeg>=thetaCutMin && photonThetas[5]*radToDeg<=thetaCutMax1) || photonThetas[5]*radToDeg>=thetaCutMax2;
        pPhoton7Theta = (photonThetas[6]*radToDeg>=thetaCutMin && photonThetas[6]*radToDeg<=thetaCutMax1) || photonThetas[6]*radToDeg>=thetaCutMax2;
        pPhoton8Theta = (photonThetas[7]*radToDeg>=thetaCutMin && photonThetas[7]*radToDeg<=thetaCutMax1) || photonThetas[7]*radToDeg>=thetaCutMax2;
        pPhotonTheta = pPhoton1Theta*pPhoton2Theta*pPhoton3Theta*pPhoton4Theta*pPhoton5Theta*pPhoton6Theta*pPhoton7Theta*pPhoton8Theta;
        ...
        pShowerQuality4 = showerQuality_FCAL[4] > 0.5;
        pShowerQuality5 = showerQuality_FCAL[5] > 0.5;
        pShowerQuality6 = showerQuality_FCAL[6] > 0.5;
        pShowerQuality7 = showerQuality_FCAL[7] > 0.5;
        // Charged Cuts
	...
	//withinBox(inBox, inBox_noOtherCuts, mEllipse_pre, locPi0Mass_Kin,locEtaMass_Kin, 0.12, 0.15, 0.51, 0.57, 0.01, 0.035);
		...
		// par3 0.134285
		// par4 0.00769639
	withinBox(inBox, inBox_noOtherCuts, mEllipse_pre, locPi0Mass,locEtaMass, 0.134285-2*0.00769639, 0.134285+2*0.00769639, 0.540383-2*0.0233172, 0.540383+2*0.0233172, 0.01, 0.02);
	...
	if ( selectDetector == "FCAL" ) { detectorCut=pEtaInFCAL; }
	    ...
	    if (used34B.find(using34B)==used34B.end()){
            ...
            if ( uniqueSpectroscopicID.find(using34)==uniqueSpectroscopicID.end() ){
                uniqueSpectroscopicID.insert(using34);
