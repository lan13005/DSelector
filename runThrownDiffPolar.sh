...
echo ""
echo ""
echo "Make sure runDSelectorThrown_7_17_14.C is setup properly with deg000 to start"
...
sed -i 's@degAngle="deg045"@degAngle="deg090"@g' runDSelectorThrown_7_17_14.C
sed -i 's@polarization="deg045"@polarization="deg090"@g' DSelector_thrown.C
root -l -q -b runDSelectorThrown_7_17_14.C 

sed -i 's@degAngle="deg090"@degAngle="deg135"@g' runDSelectorThrown_7_17_14.C
sed -i 's@polarization="deg090"@polarization="deg135"@g' DSelector_thrown.C
root -l -q -b runDSelectorThrown_7_17_14.C 

sed -i 's@degAngle="deg135"@degAngle="degAMO"@g' runDSelectorThrown_7_17_14.C
sed -i 's@polarization="deg135"@polarization="degAMO"@g' DSelector_thrown.C
root -l -q -b runDSelectorThrown_7_17_14.C 

sed -i 's@degAngle="degAMO"@degAngle="degALL"@g' runDSelectorThrown_7_17_14.C
sed -i 's@polarization="degAMO"@polarization="degALL"@g' DSelector_thrown.C
root -l -q -b runDSelectorThrown_7_17_14.C 

sed -i 's@degAngle="degALL"@degAngle="deg000"@g' runDSelectorThrown_7_17_14.C
sed -i 's@polarization="degALL"@polarization="deg000"@g' DSelector_thrown.C
