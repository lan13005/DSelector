...
#$dataFile = "$workingDir/trees/tree_pimpip_coh_2017_amptools.root";
$dataFile = "$workingDir/data_pi0eta_$nameAffix.root";
$accMCFile = "$workingDir/reco_pi0eta_$nameAffix.root";
$genMCFile = "$workingDir/thrown_pi0eta_$nameAffix.root";
...
$cfgTempl = "$workingDir/fit_etapi_moments.cfg";
...
system( "split_mass $dataFile $dataTag $lowMass $highMass $nBins $maxEvts -T Thrown_Tree:kin" );
print "splitted data!\n"; 
...
system( "split_mass $genMCFile $genMCTag $lowMass $highMass $nBins -T Thrown_Tree:kin" );
