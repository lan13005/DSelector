...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("deg000_gen_2017_trees_DSelector.root");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("thrownNotAmptoolsReady_a0a2_nameAffix.root");
      cout << "File input: deg000_gen_2017_trees_DSelector.root" << endl;
      if (!f || !f->IsOpen()) {
         f = new TFile("deg000_gen_2017_trees_DSelector.root");
      }
