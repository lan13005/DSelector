...
// ************************************************************************************************************
// ************************************************************************************************************
   m_OutTree_tLT1->Branch("E_Beam", new float, "E_Beam/F");
   m_OutTree_tLT1->Branch("Px_Beam", new float, "Px_Beam/F");
   m_OutTree_tLT1->Branch("Py_Beam", new float, "Py_Beam/F");
   m_OutTree_tLT1->Branch("Pz_Beam", new float, "Pz_Beam/F");
   m_OutTree_tLT1->Branch("Target_Mass", new float, "Target_Mass/F");
   m_OutTree_tLT1->Branch("NumFinalState", new int, "NumFinalState/I");
   m_OutTree_tLT1->Branch("PID_FinalState", new int[locNumFinalStateParticles], "PID_FinalState[NumFinalState]/I");
   m_OutTree_tLT1->Branch("E_FinalState", new float[locNumFinalStateParticles], "E_FinalState[NumFinalState]/F");
   m_OutTree_tLT1->Branch("Px_FinalState", new float[locNumFinalStateParticles], "Px_FinalState[NumFinalState]/F");
   m_OutTree_tLT1->Branch("Py_FinalState", new float[locNumFinalStateParticles], "Py_FinalState[NumFinalState]/F");
   m_OutTree_tLT1->Branch("Pz_FinalState", new float[locNumFinalStateParticles], "Pz_FinalState[NumFinalState]/F");
   /// ****************** MAKE SURE THEY TYPES MATCH!!!!!!! CHECK THE TYPE BY LOOKING AT THE FLAT TREE USING PRINT()
   m_OutTree_tLT1->Branch("Weight", new Float_t, "Weight/F");
// =============================== 
   m_OutTree_tLT06->Branch("E_Beam", new float, "E_Beam/F");
   m_OutTree_tLT06->Branch("Px_Beam", new float, "Px_Beam/F");
   m_OutTree_tLT06->Branch("Py_Beam", new float, "Py_Beam/F");
   m_OutTree_tLT06->Branch("Pz_Beam", new float, "Pz_Beam/F");
   m_OutTree_tLT06->Branch("Target_Mass", new float, "Target_Mass/F");
   m_OutTree_tLT06->Branch("NumFinalState", new int, "NumFinalState/I");
   m_OutTree_tLT06->Branch("PID_FinalState", new int[locNumFinalStateParticles], "PID_FinalState[NumFinalState]/I");
   m_OutTree_tLT06->Branch("E_FinalState", new float[locNumFinalStateParticles], "E_FinalState[NumFinalState]/F");
   m_OutTree_tLT06->Branch("Px_FinalState", new float[locNumFinalStateParticles], "Px_FinalState[NumFinalState]/F");
   m_OutTree_tLT06->Branch("Py_FinalState", new float[locNumFinalStateParticles], "Py_FinalState[NumFinalState]/F");
   m_OutTree_tLT06->Branch("Pz_FinalState", new float[locNumFinalStateParticles], "Pz_FinalState[NumFinalState]/F");
   /// ****************** MAKE SURE THEY TYPES MATCH!!!!!!! CHECK THE TYPE BY LOOKING AT THE FLAT TREE USING PRINT()
   m_OutTree_tLT06->Branch("Weight", new Float_t, "Weight/F");
// =============================== 
   m_OutTree_tGT05LT1->Branch("E_Beam", new float, "E_Beam/F");
   m_OutTree_tGT05LT1->Branch("Px_Beam", new float, "Px_Beam/F");
   m_OutTree_tGT05LT1->Branch("Py_Beam", new float, "Py_Beam/F");
   m_OutTree_tGT05LT1->Branch("Pz_Beam", new float, "Pz_Beam/F");
   m_OutTree_tGT05LT1->Branch("Target_Mass", new float, "Target_Mass/F");
   m_OutTree_tGT05LT1->Branch("NumFinalState", new int, "NumFinalState/I");
   m_OutTree_tGT05LT1->Branch("PID_FinalState", new int[locNumFinalStateParticles], "PID_FinalState[NumFinalState]/I");
   m_OutTree_tGT05LT1->Branch("E_FinalState", new float[locNumFinalStateParticles], "E_FinalState[NumFinalState]/F");
   m_OutTree_tGT05LT1->Branch("Px_FinalState", new float[locNumFinalStateParticles], "Px_FinalState[NumFinalState]/F");
   m_OutTree_tGT05LT1->Branch("Py_FinalState", new float[locNumFinalStateParticles], "Py_FinalState[NumFinalState]/F");
   m_OutTree_tGT05LT1->Branch("Pz_FinalState", new float[locNumFinalStateParticles], "Pz_FinalState[NumFinalState]/F");
   /// ****************** MAKE SURE THEY TYPES MATCH!!!!!!! CHECK THE TYPE BY LOOKING AT THE FLAT TREE USING PRINT()
   m_OutTree_tGT05LT1->Branch("Weight", new Float_t, "Weight/F");
...
// ************************************************************************************************************
// ************************************************************************************************************
   m_OutTree_tLT1->SetBranchAddress("NumFinalState", &m_nPart);
   m_OutTree_tLT1->SetBranchAddress("Target_Mass", &m_TargetMass);
   m_OutTree_tLT1->SetBranchAddress("PID_FinalState", m_PID);
   m_OutTree_tLT1->SetBranchAddress("E_FinalState", m_e);
   m_OutTree_tLT1->SetBranchAddress("Px_FinalState", m_px);
   m_OutTree_tLT1->SetBranchAddress("Py_FinalState", m_py);
   m_OutTree_tLT1->SetBranchAddress("Pz_FinalState", m_pz);
   m_OutTree_tLT1->SetBranchAddress("E_Beam", &m_eBeam);
...
// =============================== 
   ...
   m_OutTree_tLT06->SetBranchAddress("PID_FinalState", m_PID);
   m_OutTree_tLT06->SetBranchAddress("E_FinalState", m_e);
   m_OutTree_tLT06->SetBranchAddress("Px_FinalState", m_px);
   m_OutTree_tLT06->SetBranchAddress("Py_FinalState", m_py);
   m_OutTree_tLT06->SetBranchAddress("Pz_FinalState", m_pz);
   m_OutTree_tLT06->SetBranchAddress("E_Beam", &m_eBeam);
...
// =============================== 
   ...
   m_OutTree_tGT05LT1->SetBranchAddress("PID_FinalState", m_PID);
   m_OutTree_tGT05LT1->SetBranchAddress("E_FinalState", m_e);
   m_OutTree_tGT05LT1->SetBranchAddress("Px_FinalState", m_px);
   m_OutTree_tGT05LT1->SetBranchAddress("Py_FinalState", m_py);
   m_OutTree_tGT05LT1->SetBranchAddress("Pz_FinalState", m_pz);
   m_OutTree_tGT05LT1->SetBranchAddress("E_Beam", &m_eBeam);
...
// Define some constants across all events
   ...
   outFile_tLT1->Write("tLT1");
   outFile_tLT06->Write("tLT06");
   outFile_tGT05LT1->Write("tGT05LT1");
