...
void addUTWeightsBranch(string rootFileLoc, string rootFileName, string treeName){
    ...
    double UT_noTrackingWeight=1; // this branch will be all 1s. Since this one is not tracking anything
    ...
    TBranch* UT_noTrackingWeights=ut_dataTree->Branch("UT_noTrackingWeights",&UT_noTrackingWeight,"UT_noTrackingWeights/D");
