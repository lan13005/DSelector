...
void fitAsymmetryPlots4(){
	...
	TH1F *phi000_eta_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS]; // 2 for the tag and 3 for the datasets
	TH1F *phi045_eta_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS]; 
	TH1F *phi090_eta_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS];
	TH1F *phi135_eta_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS];
	TH1F *phiAMO_eta_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS];
	TH1F *phi000_pi0_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS];
	TH1F *phi045_pi0_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS];
	TH1F *phi090_pi0_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS];
	TH1F *phi135_pi0_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS];
	TH1F *phiAMO_pi0_unscaled[nTagEta][num_tBins][num_mBins][nDataSets][nSetsBS];
	// -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	// -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
