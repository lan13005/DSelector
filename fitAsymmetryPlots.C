...
void fitAsymmetryPlots(){
	...
	TH1F *phi000_eta_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS]; // 2 for the tag and 3 for the datasets
	TH1F *phi045_eta_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS]; 
	TH1F *phi090_eta_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS];
	TH1F *phi135_eta_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS];
	TH1F *phiAMO_eta_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS];
	TH1F *phi000_pi0_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS];
	TH1F *phi045_pi0_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS];
	TH1F *phi090_pi0_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS];
	TH1F *phi135_pi0_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS];
	TH1F *phiAMO_pi0_unscaled[nTagEta][num_tBins][nDataSets][nSetsBS];
	// -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	// -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		for (int iTag=0; iTag < nTagEta; ++iTag){ // nothing or backwardPi0/Etap
			for (int iteta=0; iteta<num_tBins; ++iteta){ // t bins
				...
				string nameTag = "_iData"+to_string(iData)+"_iSet0"; 
        			...
        			phi045_eta_unscaled[iTag][iteta][iData][0] = new TH1F((name0+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
        			phi045_pi0_unscaled[iTag][iteta][iData][0] = new TH1F((name1+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
        			phi090_eta_unscaled[iTag][iteta][iData][0] = new TH1F((name2+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
        			phi090_pi0_unscaled[iTag][iteta][iData][0] = new TH1F((name3+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
        			phiAMO_eta_unscaled[iTag][iteta][iData][0] = new TH1F((name4+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
        			phiAMO_pi0_unscaled[iTag][iteta][iData][0] = new TH1F((name5+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
        			phi000_eta_unscaled[iTag][iteta][iData][0] = new TH1F((name6+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
        			phi000_pi0_unscaled[iTag][iteta][iData][0] = new TH1F((name7+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
        			phi135_eta_unscaled[iTag][iteta][iData][0] = new TH1F((name8+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
        			phi135_pi0_unscaled[iTag][iteta][iData][0] = new TH1F((name9+nameTag).c_str(), "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees", 40, -180, 180);
				...
				std::vector<TH1F*> hists = {phi045_eta_unscaled[iTag][iteta][iData][0],phi045_pi0_unscaled[iTag][iteta][iData][0],phi090_eta_unscaled[iTag][iteta][iData][0]
					,phi090_pi0_unscaled[iTag][iteta][iData][0],phiAMO_eta_unscaled[iTag][iteta][iData][0],phiAMO_pi0_unscaled[iTag][iteta][iData][0]
					,phi000_eta_unscaled[iTag][iteta][iData][0],phi000_pi0_unscaled[iTag][iteta][iData][0],phi135_eta_unscaled[iTag][iteta][iData][0]
					,phi135_pi0_unscaled[iTag][iteta][iData][0]};
				...
				for ( int iHist=0; iHist<nHists; ++iHist){
					...
					hists[iHist]->Print();
					nevents[iHist] = values[iTag][iteta][iData][iHist].size();	
				...
				for (int iSet=1; iSet<nSetsBS; ++iSet){ // we add 1 since using the full dataset takes the first element of the array
					...
					string cutTag = "Cuts=ptEtaBeamAsym;#phi; Entries / 9 degrees";
        				phi045_eta_unscaled[iTag][iteta][iData][iSet] = new TH1F((name0+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
        				phi045_pi0_unscaled[iTag][iteta][iData][iSet] = new TH1F((name1+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
        				phi090_eta_unscaled[iTag][iteta][iData][iSet] = new TH1F((name2+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
        				phi090_pi0_unscaled[iTag][iteta][iData][iSet] = new TH1F((name3+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
        				phiAMO_eta_unscaled[iTag][iteta][iData][iSet] = new TH1F((name4+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
        				phiAMO_pi0_unscaled[iTag][iteta][iData][iSet] = new TH1F((name5+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
        				phi000_eta_unscaled[iTag][iteta][iData][iSet] = new TH1F((name6+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
        				phi000_pi0_unscaled[iTag][iteta][iData][iSet] = new TH1F((name7+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
        				phi135_eta_unscaled[iTag][iteta][iData][iSet] = new TH1F((name8+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
        				phi135_pi0_unscaled[iTag][iteta][iData][iSet] = new TH1F((name9+nameTag).c_str(), cutTag.c_str(), 40, -180, 180);
					hists = {phi045_eta_unscaled[iTag][iteta][iData][iSet],phi045_pi0_unscaled[iTag][iteta][iData][iSet],phi090_eta_unscaled[iTag][iteta][iData][iSet]
						,phi090_pi0_unscaled[iTag][iteta][iData][iSet],phiAMO_eta_unscaled[iTag][iteta][iData][iSet],phiAMO_pi0_unscaled[iTag][iteta][iData][iSet]
						,phi000_eta_unscaled[iTag][iteta][iData][iSet],phi000_pi0_unscaled[iTag][iteta][iData][iSet],phi135_eta_unscaled[iTag][iteta][iData][iSet]
						,phi135_pi0_unscaled[iTag][iteta][iData][iSet]};
					int randIdx;
					for ( int iHist=0; iHist<nHists; ++iHist){
						for (int ievent=0; ievent<nevents[iHist]; ++ievent){
							randIdx = rand() % nevents[iHist];		
							value = values[iTag][iteta][iData][iHist][randIdx];
							weight = weights[iTag][iteta][iData][iHist][randIdx];
							hists[iHist]->Fill(value, weight);
						}
					}
				}
	...
	for (int iSet=0; iSet <nSetsBS; ++iSet) {
		for (int iTag=0; iTag < nTagEta; ++iTag) {
			for (int iteta=0; iteta<num_tBins; ++iteta){
				...
				phi000_eta_total[iTag][iteta] = (TH1F *)phi000_eta_unscaled[iTag][iteta][0][iSet]->Clone();
				phi000_pi0_total[iTag][iteta] = (TH1F *)phi000_pi0_unscaled[iTag][iteta][0][iSet]->Clone();
				phi135_eta_total[iTag][iteta] = (TH1F *)phi135_eta_unscaled[iTag][iteta][0][iSet]->Clone();
				phi135_pi0_total[iTag][iteta] = (TH1F *)phi135_pi0_unscaled[iTag][iteta][0][iSet]->Clone();
				...
				phi045_eta_total[iTag][iteta] = (TH1F *)phi045_eta_unscaled[iTag][iteta][0][iSet]->Clone();
				phi045_pi0_total[iTag][iteta] = (TH1F *)phi045_pi0_unscaled[iTag][iteta][0][iSet]->Clone();
				phi090_eta_total[iTag][iteta] = (TH1F *)phi090_eta_unscaled[iTag][iteta][0][iSet]->Clone();
				phi090_pi0_total[iTag][iteta] = (TH1F *)phi090_pi0_unscaled[iTag][iteta][0][iSet]->Clone();
				phiAMO_eta_total[iTag][iteta] = (TH1F *)phiAMO_eta_unscaled[iTag][iteta][0][iSet]->Clone();
				phiAMO_pi0_total[iTag][iteta] = (TH1F *)phiAMO_pi0_unscaled[iTag][iteta][0][iSet]->Clone();
				...
				for (int iData=1; iData < nDataSets; ++iData){
					...
					totalEntriesInPhi000_eta_total += phi000_eta_unscaled[iTag][iteta][iData][iSet]->GetEntries();
					...
					phi000_eta_unscaled[iTag][iteta][iData][iSet]->Scale(fluxRatios_90_0[0]);
					phi000_pi0_unscaled[iTag][iteta][iData][iSet]->Scale(fluxRatios_90_0[0]);
					phi135_eta_unscaled[iTag][iteta][iData][iSet]->Scale(fluxRatios_45_135[0]);
					phi135_pi0_unscaled[iTag][iteta][iData][iSet]->Scale(fluxRatios_45_135[0]);
					phi000_eta_total[iTag][iteta]->Add(phi000_eta_unscaled[iTag][iteta][iData][iSet]);
        	        		phi000_pi0_total[iTag][iteta]->Add(phi000_pi0_unscaled[iTag][iteta][iData][iSet]);
        	        		phi135_eta_total[iTag][iteta]->Add(phi135_eta_unscaled[iTag][iteta][iData][iSet]);
        	        		phi135_pi0_total[iTag][iteta]->Add(phi135_pi0_unscaled[iTag][iteta][iData][iSet]);

					// Dont have to scale these guys so just add them
        	        		phi045_eta_total[iTag][iteta]->Add(phi045_eta_unscaled[iTag][iteta][iData][iSet]);
        	        		phi045_pi0_total[iTag][iteta]->Add(phi045_pi0_unscaled[iTag][iteta][iData][iSet]);
        	        		phi090_eta_total[iTag][iteta]->Add(phi090_eta_unscaled[iTag][iteta][iData][iSet]);
        	        		phi090_pi0_total[iTag][iteta]->Add(phi090_pi0_unscaled[iTag][iteta][iData][iSet]);
        	        		phiAMO_eta_total[iTag][iteta]->Add(phiAMO_eta_unscaled[iTag][iteta][iData][iSet]);
        	        		phiAMO_pi0_total[iTag][iteta]->Add(phiAMO_pi0_unscaled[iTag][iteta][iData][iSet]);
				}
			}
		}	
		...
		double asymmetries_000_eta[nSetsBS][num_tBins];
		double asymmetries_045_eta[nSetsBS][num_tBins];
		double asymmetries_000_eta_err[nSetsBS][num_tBins];
		double asymmetries_045_eta_err[nSetsBS][num_tBins];
		double asymmetries_000_pi0[nSetsBS][num_tBins];
		double asymmetries_045_pi0[nSetsBS][num_tBins];
		double asymmetries_000_pi0_err[nSetsBS][num_tBins];
		double asymmetries_045_pi0_err[nSetsBS][num_tBins];
		...
		for (int iTag=0; iTag<nTagEta; ++iTag){
			for (int iteta=0; iteta<num_tBins; ++iteta){ //num_tBins
				...
				asymmetries_000_eta[iSet][iteta] = fit_asym->GetParameter(2);
				asymmetries_000_eta_err[iSet][iteta] = fit_asym->GetParError(2);
				...
				asymmetries_045_eta[iSet][iteta] = fit_asym->GetParameter(2);
				asymmetries_045_eta_err[iSet][iteta] = fit_asym->GetParError(2);
				...
				if ( iSet < maxPrintBS ){ allCanvases->SaveAs(("asymmetryPlots/asymmetry"+tagEta[iTag]+"_tetaBin"+to_string(iteta)+"_iSet"+to_string(iSet)+".png").c_str()); }
				...
				if ( iSet < maxPrintBS ){ allCanvases->SaveAs(("asymmetryPlots/likelihood"+tagEta[iTag]+"_tetaBin"+to_string(iteta)+"_iSet"+to_string(iSet)+".png").c_str()); }
				...
				asymmetries_000_pi0[iSet][iteta] = fit_asym->GetParameter(2);
				asymmetries_000_pi0_err[iSet][iteta] = fit_asym->GetParError(2);
				...
				asymmetries_045_pi0[iSet][iteta] = fit_asym->GetParameter(2);
				asymmetries_045_pi0_err[iSet][iteta] = fit_asym->GetParError(2);
				TGraph* likelihoodFit_045_135_pi0 = new TGraph(50); 
				fitPointer->Scan(2,likelihoodFit_045_135_pi0,-2,2);

				if ( iSet < maxPrintBS ){ allCanvases->SaveAs(("asymmetryPlots/asymmetry"+tagPi0[iTag]+"_tpi0Bin"+to_string(iteta)+"_iSet"+to_string(iSet)+".png").c_str()); }
				...
				if ( iSet < maxPrintBS ){ allCanvases->SaveAs(("asymmetryPlots/phiYieldFits"+tagEta[iTag]+"_tetaBin"+to_string(iteta)+"_iSet"+to_string(iSet)+".png").c_str()); }
				...
				if ( iSet < maxPrintBS ){ allCanvases->SaveAs(("asymmetryPlots/phiYieldFits"+tagPi0[iTag]+"_tpi0Bin"+to_string(iteta)+"_iSet"+to_string(iSet)+".png").c_str()); }
			...
			allCanvases->Divide(2,1);
			allCanvases->cd(1);
			auto gr_000 = new TGraphErrors(num_tBins,tBins,asymmetries_000_eta[iSet],tBins_err,asymmetries_000_eta_err[iSet]);
			...
			gr_000 = new TGraphErrors(num_tBins,tBins,asymmetries_000_pi0[iSet],tBins_err,asymmetries_000_pi0_err[iSet]);
			gr_000->SetTitle("Beam Asymmetry 0/90 Orientation");
			...
			allCanvases->cd(2);
			auto gr_045 = new TGraphErrors(num_tBins,tBins,asymmetries_045_eta[iSet],tBins_err,asymmetries_045_eta_err[iSet]);
			...
			gr_045 = new TGraphErrors(num_tBins,tBins,asymmetries_045_pi0[iSet],tBins_err,asymmetries_045_pi0_err[iSet]);
			gr_045->SetTitle("Beam Asymmetry 45/135 Orientation");
